...
export const gcpCapabilityMeterMap: readonly CapabilityMeterRow[] = [
  ...
  },
  {
    ...
    meterId: "gcs-class-b-10k",
    meterSku: "Cloud Storage Class B operations (get object)",
    unit: "10k-ops",
    confidence: "Low",
    sourceUrl: "https://cloud.google.com/storage/pricing",
  ...
  },
  {
    ...
    permissionSignal: "GCS data reads + connector ephemeral infra",
    meterId: "gcs-class-a-10k",
    meterSku: "Cloud Storage Class A operations (list objects)",
    unit: "10k-ops",
    confidence: "Low",
    sourceUrl: "https://cloud.google.com/storage/pricing",
  },
  ...
  },
  {
    ...
    permissionSignal: "Network egress from VPC to destination",
    meterId: "gcp-egress-gb",
    meterSku: "VPC network egress",
    unit: "GB",
    confidence: "Low",
