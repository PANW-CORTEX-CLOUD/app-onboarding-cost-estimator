...
export const awsCapabilityMeterMap: readonly CapabilityMeterRow[] = [
  ...
  },
  {
    ...
    meterId: "s3-get-10k",
    meterSku: "S3 GET requests (Tier2)",
    unit: "10k-ops",
    confidence: "Low",
    sourceUrl: "https://aws.amazon.com/s3/pricing/",
  ...
  },
  {
    ...
    permissionSignal: "S3 data-plane reads + connector ephemeral infra",
    meterId: "s3-put-10k",
    meterSku: "S3 LIST requests (Tier1)",
    unit: "10k-ops",
    confidence: "Low",
    sourceUrl: "https://aws.amazon.com/s3/pricing/",
  },
  ...
  },
  {
    ...
    permissionSignal: "Network egress from VPC / S3 to destination",
    meterId: "aws-egress-gb",
    meterSku: "EC2/S3 data transfer out",
    unit: "GB",
    confidence: "Low",
    sourceUrl: "https://aws.amazon.com/ec2/pricing/on-demand/",
